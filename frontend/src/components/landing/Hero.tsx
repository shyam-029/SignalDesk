      ...
      <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 md:px-6 md:pb-24 md:pt-24">
        <div className="grid items-center gap-12 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            >
              SignalDesk reads the same public numbers everyone else sees — and does the
              unglamorous work of turning them into structured, explainable research:
              fundamentals, relative valuation, technical positioning, and news sentiment,
              synthesized into one defensible signal.
            </motion.p>
            <motion.div
          ...
          >
            <div className="border border-line bg-surface">
              ...
              <div className="num grid grid-cols-3 gap-px border-t border-line bg-line text-[11px]">
                <Cell k="Fundamental" v="98" />
                <Cell k="Technical" v="27" />
                <Cell k="Sentiment" v="39" />
              </div>
            </div>
...
function Sparkline({ points }: { points: number[] }) {
  ...
  return (
    <div className="px-4 pt-4">
      ...
      <p className="num mb-1 text-right text-[10px] text-faint">6-month close · daily bars</p>
    </div>
  );
}
