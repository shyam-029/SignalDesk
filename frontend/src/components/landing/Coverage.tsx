...
/**
 * Coverage — the honest product vision: equities are live today; ETFs and
 * mutual funds are the planned expansion (they are core product vision in the
 * roadmap, not fake capabilities). Three different treatments, not three
 * identical cards.
 */
      ...
      <div className="mx-auto max-w-6xl px-4 py-20 md:px-6 md:py-28">
        <Reveal>
          ...
          <p className="mt-4 max-w-xl text-muted">
            The research framework is asset-class specific, so each surface gets its own
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-12">
          ...
          <Reveal className="lg:col-span-5">
            <div className="flex h-full flex-col border border-line bg-surface p-6">
              <div className="flex items-center justify-between">
                <p className="label-caps">Equities</p>
                <span className="inline-flex items-center gap-1 text-[11px] font-medium text-band-positive">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted">
                ...
                news sentiment, and grounded explanations.
              </p>
          ...
          {/* ETFs + Mutual Funds: planned, honestly marked. */}
          <div className="grid gap-8 lg:col-span-7">
            <Reveal delay={0.08} className="lg:col-span-12">
              <div className="flex flex-col border border-dashed border-line p-6 md:flex-row md:items-start md:justify-between md:gap-8">
                <div className="max-w-md">
                  <div className="flex items-center justify-between">
                    <p className="label-caps">Mutual funds</p>
                ...
                <div className="num mt-6 shrink-0 space-y-1 text-[11px] text-faint md:mt-0">
            ...
            <Reveal delay={0.16} className="lg:col-span-12">
              <div className="flex flex-col border border-dashed border-line p-6 md:flex-row md:items-center md:justify-between md:gap-8">
                <div className="max-w-xl">
                  <div className="flex items-center justify-between">
                    <p className="label-caps">ETFs</p>
