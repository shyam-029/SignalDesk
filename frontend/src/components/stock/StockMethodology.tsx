 ...
 * was built, and the deliberate separation between Alpha and valuation.
 */
    ...
    <section id="methodology" className="border-b border-line last:border-b-0">
      <div className="mx-auto max-w-6xl px-4 py-12 md:px-6">
        ...
        <p className="num mt-4 text-[11px] text-faint">
          ...
          sentiment via FinBERT · generated explanations are grounded in computed data and are
...
const BLOCKS = [
  {
    title: "Alpha Score",
    body: "40% fundamental + 30% technical + 30% sentiment, renormalized over available components. Valuation is deliberately NOT blended in — multiples already derive from fundamentals, so blending would double-count.",
  },
  {
  ...
  {
    title: "Valuation",
    body: "Relative multiples: P/E, EV/EBITDA, P/B and P/S against the median of same-industry peers from the catalog. Outside ±5% of the median a stock reads undervalued/overvalued; within the band, fairly valued. 'Cheaper than peers' ≠ intrinsically cheap.",
  },
  {
    title: "Sentiment",
    body: "Recent news per stock is scored by FinBERT (positive/negative/neutral). The confidence-weighted net score (−1..+1) maps to 0–100 for the Alpha blend.",
  },
  {
